...
export default function Icon({ name, size = 20 }: IconProps) {
  const paths: Record<IconName, ReactNode> = {
    ...
    linkedin: (
      <path d="M6.5 8.5H3.5V20h3V8.5ZM5 3.5a1.75 1.75 0 1 0 0 3.5 1.75 1.75 0 0 0 0-3.5ZM20.5 13.4c0-3.45-1.84-5.05-4.3-5.05a3.72 3.72 0 0 0-3.36 1.85V8.5h-3V20h3v-5.7c0-1.5.28-2.95 2.14-2.95 1.83 0 1.85 1.71 1.85 3.05V20h3l.67-6.6Z" />
    ),
